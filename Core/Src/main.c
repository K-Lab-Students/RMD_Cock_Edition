...
{    if(HAL_CAN_GetRxMessage(hcan1, CAN_RX_FIFO0, &RxHeader, RxData) == HAL_OK)
    {
//    //	if(RxHeader.StdId == RMD_Actuator.id && RxData[0] == 0x60){
//	  if(RxHeader.StdId == RMD_Actuator.id){
//		  motor_receive_pos(&RMD_Actuator, RxData);
...
//  HAL_Delay(10);
  ...
  HAL_Delay(2000);
  GYEMSDevicePositionControlCmd2(&servo1, 0, 20000);
//  GYEMSDevicePositionControlCmd1(&servo1, 180);
//    GYEMSDevicePositionControlCmd4(&servo1, 15000, 1000, 1);
//  GYEMSDevicePositionControlCmd4(&servo1, 36000, 0x202, 0x00);
//  GYEMSDevicePositionControlCmd3(&servo1, 300, 0);
//  GYEMSDeviceSpeedControlCmd(&servo1, 10000);
...
//	 runParam = 1;
//	 GYEMSDeviceWriteCurrPosToROMAsZero(&servo1);
//     }
//	 break;
//
//
//
//	 case 1:
//	 GYEMSDevicePositionControlCmd1(&servo1, 30);
//	 HAL_Delay(20);
//	 runParam = 3;
//	 HAL_Delay(300);
//	 GYEMSDeviceTorqueCurrControlCmd(&servo1, -1.5f);
